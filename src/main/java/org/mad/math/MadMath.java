...
public class MadMath
{
	 ...
	 */
	public static int getIntSumFromList(List<Integer> integers)
	{
		int total = 0;
	 ...
	 */
	public static int getIntAverageFromList(List<Integer> integers)
	{
		int total = getIntSumFromList(integers);
	 ...
	 */
	public static double getDoubleSumFromList(List<Double> doubles)
	{
		double total = 0.0;
	...
	{
		double total = getDoubleSumFromList(d);
		return total / d.size();
	}
	...
	public static int greatestCommonFactor(List<Integer> numbers)
	{
		...
		// get factors for each number in numbers
